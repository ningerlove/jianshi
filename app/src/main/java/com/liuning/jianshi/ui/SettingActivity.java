...
import com.liuning.jianshi.ui.widget.BgColorPickDialogFragment;
...
public class SettingActivity extends BaseActivity {
  ...
  @BindView(R.id.version_upgrade_title)
  TextView versionUgradeTitle;

  @BindView(R.id.version_upgrade_warning)
...
//    Log.d("liuning","aaaaaaaaaaaa");
//    Boolean temp = userPrefs.getVerticalWrite();
//    String tem1 = String.valueOf(temp);
//    Log.d("liuning","ddddddddddddd");
