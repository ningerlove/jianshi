...
package com.liuning.jianshi.db.service;
...
import com.liuning.jianshi.db.model.Diary_Table;
import com.liuning.jianshi.di.ForApplication;
import com.liuning.jianshi.sync.Change;
import com.liuning.jianshi.sync.Operation;
import com.liuning.jianshi.sync.SyncService;
import com.liuning.jianshi.util.DateUtil;
...
public class DiaryService {
  ...
  private List<Diary> fetchDiaryListFromDB() {
    ...
    return SQLite.select()
        .from(Diary.class)
        .where(Diary_Table.time_removed.eq(temp))
        .queryList();
  }
